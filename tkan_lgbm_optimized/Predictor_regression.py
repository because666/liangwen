...
4. T-KAN 编码器提取 128 维特征 → 回归 LightGBM 预测
...
class Predictor:
    ...
    def __init__(self):
        ...
        self.regression_mode = checkpoint.get('regression_mode', True)
        ...
        print(f"回归 LightGBM 模型加载成功: {len(self.lgbm_models)} 个窗口")
